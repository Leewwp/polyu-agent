...
/**
 * 会话分享关闭态兜底：flag 关（默认）时 PublicAgentShareController 不装配，
...
@ConditionalOnProperty(name = "agent.share.enabled", havingValue = "false", matchIfMissing = true)
public class PublicAgentShareDisabledController {
