...
- **Accounts**: email registration/verification, anonymous-trial quota, public answer sharing (immutable snapshots), account deletion (with cooling-off recovery) — all feature-flag controlled and off by default
