...
/**
 * U11-④ 注册页机检面：U8 勾选确认门（未勾选不放行注册）、注册→验证→完成三步流转、
...
describe("RegisterPage", () => {
  ...
  it("blocks submit until the agreement checkbox is checked (U8 gate)", async () => {
  ...
  it("shows the privacy/terms agreement copy with legal links (U8)", () => {
    renderPage();
