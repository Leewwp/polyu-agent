...
/**
 * 公开资讯只读控制器（U12-A，doc 19 §4-3）
 *
 * <p>路径在 SaTokenConfig 登录拦截白名单（/public/news/**）；资讯浏览永久免登录（D2），
...
public class PublicNewsController {
    ...
    /**
     * 热点榜 Top N（热度倒序；A4 热度模型灌值前按发布时间兜底）
     */
    @GetMapping("/hot")
    public Result<List<NewsItemVO>> hot(@RequestParam(value = "limit", defaultValue = "10") int limit) {
